---
title: "Pudicus: The Inspected-by Sticker for Agent Swarms"
slug: "pudicus"
date: "2026-08-31T17:30:00-04:00"
authors:
  - author: <a href="/ryan">Ryan Porter</a>
excerpt: "Pudicus is out. It's a cryptographic produce sticker for agent swarms: a signed receipt that a pinned checker ran before deploy, not a human on every diff."
...
**[Pudicus](https://github.com/AnthusAI/Pudicus) is out.** It's an open-source inspection gate that writes checkable receipts for agent-written code.
...
We're running Pudicus on all of our agent-written commits. You can [view the source code and install it from GitHub](https://github.com/AnthusAI/Pudicus). If you need help operating agent factories with a gate, talk to us at [anth.us](https://anth.us).
