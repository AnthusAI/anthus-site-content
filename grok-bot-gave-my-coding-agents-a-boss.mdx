...
On the first night, a bot went live in the Anthus AI Solutions Discord and sat in `#general`. [Papyrus](https://papyrus.anth.us) started an hourly research watch. A separate site bot received a link, created a post, and handed it to Amplify. While that build ran, the site bot asked the research bot for a trend briefing.
