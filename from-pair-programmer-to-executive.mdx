...
<BlogImage
  ...
  className="centered"
  alt="A human directs a small organization of coding bots, each working independently from a separate office pod."
/>
