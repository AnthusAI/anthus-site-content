...
tags: ['explainer', 'how-to', 'research']
...
In our recent look at machine-learning (ML) text classifiers, we showed how a business can cut costs by orders of magnitude by using AI solutions that [efficiently solve problems](/blog/maximize-profit-not-intelligence/) with smaller, cheaper models. A custom-trained ML model can perform as well or even better than more-powerful large language models (LLMs) for specific business use cases. But how do you create a small, cheap model that can perform as well as an LLM?
