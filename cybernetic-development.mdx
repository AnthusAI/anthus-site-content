...
/>, recognized this shift just a year later. Reflecting on the concept's anniversary, he noted that while vibe coding started as a way to build "fun throwaway projects," the industry quickly moved toward something more rigorous. He called it **"Agentic Engineering"**—where you get the speed of agents without compromising on quality.<Citation
  data={{
    type: "webpage",
    "container-title": "X (formerly Twitter)",
...
Lee Robinson's $260 migration proved this. By ripping out the CMS (a human-friendly abstraction) and replacing it with raw Markdown files (machine-friendly code), he made it possible for agents to manage the content. The "simplification" was actually a **complexification** from the agent's perspective.
...
This proves that **simplifying to code** isn't a step backward; it is the necessary step forward to enable the cybernetic workforce.
...
This is uncomfortable. Most developers became developers because they loved building things, not managing things. But AI has made building cheap and management scarce. The only way to reach 100x output is to embrace the boss role.
