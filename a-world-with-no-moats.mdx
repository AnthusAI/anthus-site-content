...
In the late 1980s and early 1990s, Microsoft's operating systems stood unchallenged, wrapped in a mystique of secrecy. The company's "Fear, Uncertainty, and Doubt" marketing strategy implied that Windows had exclusive, magical capabilities necessary for computing — <mark>alternatives barely even existed</mark> because Microsoft had convinced most people there weren't any worth considering. They said the code stayed closed and secret for our protection: hackers couldn't exploit what they couldn't see. But security doesn't work that way. It was for Microsoft's protection, not ours.
...
But the recent upheaval <mark>vaporized this mystique within one bizarre hour.</mark> Microsoft's market value tumbled by about fifty billion dollars because of the OpenAI board's inept timing in announcing Sam Altman's firing before markets closed. The dramatic leadership changes exposed OpenAI's unique governance structure as a liability rather than a strength, introducing instability and unpredictability. A mission that doesn't prioritize business continuity doesn't make for a good business partner.
...
For OpenAI customers like Anthus, this creates real uncertainty. <mark>OpenAI's mission doesn't align with the interests of any business.</mark> The board's willingness to jeopardize the future of its employees, partners, and customers casts doubt on the long-term viability of anything built on the OpenAI API.
...
Our initial experience with generative AI via OpenAI was exhilarating. Quickly, their API services became our go-to solution. But that created a dependency we hadn't meant to build, and we stopped evaluating alternatives as often as we should have.
...
The OpenAI debacle has solidified one of our [core values](/about/#our-values): to commodify AI models and services, treating them as interchangeable tools rather than proprietary solutions. This shift towards a more independent and versatile approach is not merely about cost-savings or information security: It's about staying ahead in a quickly-changing game, where choosing sides among the giants is not the path to stability. In a world with no moats, don't get too invested in any given castle.
