...
<figure className="center-full-image">
  <BlogImage
    ...
    className="full"
    alt="Grouped bars of accuracy by difficulty tier. All four systems score 1.00 on strong. On medium: Jev with the layer 0.95, Laya with the layer 0.84, fine-tuned Laya 1.00, DistilBERT 0.71. On weak: 0.88, 0.79, 0.95, 0.87. On neutral: 0.72, 0.70, 0.67, 0.78."
  />
  <figcaption className="image-caption">
    Accuracy by tier on the 600 held-out items (72 strong, 106 medium, 277 weak,
    145 neutral). Fine-tuned Laya wins the two middle tiers. On neutral items
    it's last and DistilBERT is first.
  </figcaption>
</figure>
