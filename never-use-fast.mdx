...
A pinned model and a Fast toggle look like personal preferences. They're workplace controls — defaults the team owns, not soft settings you rediscover chat by chat. [Own those defaults on purpose](https://chattic.us/thoughts/own-the-defaults/) or the vendor's factory preset keeps winning.
