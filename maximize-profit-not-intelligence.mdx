...
Picture this: you're at the helm of a startup, brimming with ideas, ready to build on the marvels of AI, particularly the genius of GPT 4.  You set out looking for opportunities in text classifiers:<Citation
  data={{
    type: "webpage",
...
No problem.  GPT 4's <a href="/blog/how-ai-agents-do-things/">function-calling</a> feature can generate structured responses.  You jump into VS Code and use GPT 4 in GitHub Copilot to craft a text classifier based on GPT 4, and it's 97% accurate when you evaluate it.  It works!
...
/> It uses neural networks and operates on the principle that words appearing in similar contexts have similar meanings.
