...
That night, combined with the new coding capabilities of generative AI, I realized something bigger was happening. It's no longer just about the apps or tools we build in anticipation of problems. The YAGNI principle, now turbocharged by AI, leads to a new principle: <mark>Focus on solutions, not on tools.</mark> It's about being agile and responsive, crafting solutions in real-time as challenges arise. And, crucially for professional software developers, <mark>it will change how the market values software projects.</mark> It will also <mark>reduce demand for developers to invest value in big software projects.</mark>
...
By mirroring the CAPEX-to-OPEX shift seen in cloud computing, generative AI gives businesses <mark>a paradigm shift towards greater business agility</mark>: staying nimble, investing in tailor-made tools on an as-needed basis, and making sure every software investment corresponds to a real, immediate need.

## Cloud computing did this for hardware. AI is doing it for software.

Cloud computing opened doors to computing power for everyone from small businesses to individuals, breaking down the monopoly of large corporations. That same shift is now unfolding in software. Smaller teams and individual entrepreneurs are harnessing AI-driven tools for business innovation, bypassing the hefty financial burdens of traditional software development. This change enables a diverse group of innovators to undertake <mark>projects that were once financially out of reach.</mark>

## Rethinking Applications: Adapting to On-Demand Solutions

As computers get better at providing solutions on demand, the role of traditional operating systems and applications invites reconsideration.
...
## Conclusion: Solutions Over Tools

We're part of a shift in business software investment that echoes what cloud computing did for hardware. The guiding principle is clear: <mark>focus on solutions, not tools.</mark> Custom-fit, on-demand solutions are becoming the standard, and that's not just about access to technology — it's about making software investment track more closely with what people and businesses actually need.